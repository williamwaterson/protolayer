...
void CurveNetworkLevel::evaluatePositions(Mesh& subdivision)
{
...
void CurveNetworkLevel::subdivideMesh(Mesh& subdivision)
{
  for (int i = 0; i < subdivision.getNumberVertices(); i++) {
    Vertex& vertex = subdivision.getVertex(i);
...
CurveNetworkLevel::CurveNetworkLevel(Mesh& subdivision)
{
...
Mesh& CurveNetworkLevel::getMesh()
{
  return _mesh;
}


const Mesh& CurveNetworkLevel::getMesh() const
{
  return _mesh;
}
