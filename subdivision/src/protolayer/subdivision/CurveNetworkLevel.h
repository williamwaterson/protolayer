#ifndef PROTOLAYER_SUBDIVISION_CURVENETWORKLEVEL_H
#define PROTOLAYER_SUBDIVISION_CURVENETWORKLEVEL_H
...
public:
   ...
   * <p>
   */
  explicit CurveNetworkLevel(Mesh& subdivision);
...
#endif // PROTOLAYER_SUBDIVISION_CURVENETWORKLEVEL_H
