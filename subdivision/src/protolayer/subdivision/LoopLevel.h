#ifndef PROTOLAYER_SUBDIVISION_LOOPLEVEL_H
#define PROTOLAYER_SUBDIVISION_LOOPLEVEL_H
...
public:
   ...
   * <p>
   */
  explicit LoopLevel(Mesh& subdivision);
...
#endif // PROTOLAYER_SUBDIVISION_LOOPLEVEL_H
