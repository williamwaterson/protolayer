                 ...
                 style::Appearance& appearance)
{
  ...
  _lines = new protolayer::renderer::Geometry(protolayer::renderer::Geometry::LINES);
  ...
  _edges = new renderer::LegacyShape(*_lines, appearance);
  addChild(*_edges);
}
...
style::Appearance& HexMesh::getAppearance()
{
