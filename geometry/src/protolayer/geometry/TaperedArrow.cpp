...
renderer::LegacyShape& TaperedArrow::getEdges()
{
  return *_edges;
}


renderer::LegacyShape& TaperedArrow::getFaces()
{
  return *_faces;
}


float* TaperedArrow::getStart()
{
  return _vertices[0];
}


float* TaperedArrow::getEnd()
{
  return _vertices[3];
}


float* TaperedArrow::getPosition()
{
  return _midpoint;
}


int TaperedArrow::getNumberEdges()
{
  return NUMBER_VERTICES;
}


int TaperedArrow::getNumberTriangles()
{
  return 4;
}


void TaperedArrow::evaluatePosition()
{
...
void TaperedArrow::recalculateVertices()
{
  for (int i = 0; i < 5; i++) {
      _vertices[i+1][0] =
