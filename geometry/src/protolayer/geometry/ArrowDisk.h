#ifndef PROTOLAYER_GEOMETRY_ARROWDISK_H
#define PROTOLAYER_GEOMETRY_ARROWDISK_H
 ...
 */
class ArrowDisk : public scenegraph::Group
{
public:
  /** TODO: Documentation */
...
private:
   ...
   * <p>
   */
  ArrowDisk(const ArrowDisk& arrowDisk);

  /**
   * Private and unimplemented to enforce reference semantics
   * <p>
   */
  ArrowDisk& operator=(const ArrowDisk& arrowDisk);
...
#endif // PROTOLAYER_GEOMETRY_ARROWDISK_H
