#ifndef PROTOLAYER_CPPDOCLET_POOLDOCLET_H
#define PROTOLAYER_CPPDOCLET_POOLDOCLET_H
...
public:
  PoolDoclet(Namespace& root, const std::string& outputDir);

  void createOpeningMacros();

  void createClosingMacros();
