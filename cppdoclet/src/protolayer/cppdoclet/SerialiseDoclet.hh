...
public:
  SerialiseDoclet(Dependencies& dependencies, const std::string& outputDir = "./");
  ...
  void generateReferenceEncoder(Class& instance, Attribute& attribute);

  void generateReferenceDecoder(Class& instance, Attribute& attribute);

  void generatePointerEncoder(Class& instance, Attribute& attribute);

  void generatePointerDecoder(Class& instance, Attribute& attribute);
