...
{
  scenegraph::crossProduct(a, b, result);
  normalise(result);
}
...
InstanceCreation::InstanceCreation(StateLayer& stateLayer) :
...
void InstanceCreation::mouseDown(float x, float y, int clickCount)
{
...
void InstanceCreation::mouseMoved(float x, float y)
{
  protolayer::proto::GraphInteraction::mouseMoved(x, y);
}


void InstanceCreation::mouseDragged(float x, float y)
{
...
void InstanceCreation::mouseUp(float x, float y)
{
  protolayer::proto::GraphInteraction::mouseUp(x, y);
}


void InstanceCreation::keyDown()
{
}


void InstanceCreation::keyUp()
{
}
