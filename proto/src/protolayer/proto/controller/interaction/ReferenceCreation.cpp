...
ReferenceCreation::ReferenceCreation(StateLayer& stateLayer) :
...
void ReferenceCreation::mouseDown(float x, float y, int clickCount)
{
...
void ReferenceCreation::mouseMoved(float x, float y)
{
  protolayer::proto::GraphInteraction::mouseMoved(x, y);
}


void ReferenceCreation::mouseDragged(float x, float y)
{
...
void ReferenceCreation::mouseUp(float x, float y)
{
  protolayer::proto::GraphInteraction::mouseUp(x, y);
}


void ReferenceCreation::keyDown()
{
}


void ReferenceCreation::keyUp()
{
}
