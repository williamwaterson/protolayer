#ifndef PROTOLAYER_SCENEGRAPH_GROUP_H
#define PROTOLAYER_SCENEGRAPH_GROUP_H
...
public:
  ...
  /** Access iterator types */
  typedef std::vector <Shape*>::iterator ShapeVectorIteratorType;
...
private:
  ...
  /** TODO: Documentation */
  std::vector <Shape*> _childShapesOrder;

  /** TODO: Documentation */
  std::vector <Group*> _childGroupsOrder;
...
public:
   ...
   * <p>
   */
  ShapeVectorIteratorType getOrderedChildShapes();

  /**
   * TODO: Documentation
   * <p>
   */
  ShapeVectorIteratorType getOrderedLastShape();
...
#endif // PROTOLAYER_SCENEGRAPH_GROUP_H
