...
PushDissolve::PushDissolve(float timePeriod)
{
  _inProgress = false;
...
void
PushDissolve::setTargetPoint(float x, float y, float z)
{
  _targetPosition[0] = x;
  _targetPosition[1] = y;
  _targetPosition[2] = z;
...
void
PushDissolve::commence(Shot& initialShot, Shot& finalShot)
{
  Microseconds(&_tick);
...
void
PushDissolve::increment(Shot& initialShot, Shot& finalShot)
{
  Microseconds(&_tick);
...
void
PushDissolve::postComplete(Shot& initialShot, Shot& finalShot)
{
