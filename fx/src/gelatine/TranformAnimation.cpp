...
MovingShot::MovingShot(long timePeriod,
  ...
  _oldPosition[0] = camera->_position[0];
  _oldPosition[1] = camera->_position[1];
  _oldPosition[2] = camera->_position[2];
...
{
  _oldPosition[0] = _camera->_position[0];
  _oldPosition[1] = _camera->_position[1];
  _oldPosition[2] = _camera->_position[2];
...
MovingShot::increment(long timeCurrent)
{
  ...
  if (_fraction > UNITY) {
    _camera->_position[0] = _finalPosition[0];
    _camera->_position[1] = _finalPosition[1];
    _camera->_position[2] = _finalPosition[2];

    _camera->_target[0] = _finalPosition[0];
    _camera->_target[1] = _finalPosition[1];
    _camera->_target[2] = _finalPosition[2];
