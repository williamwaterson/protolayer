#ifndef PROTOLAYER_FX_REFOCUS_H
#define PROTOLAYER_FX_REFOCUS_H
...
public:
   ...
   * <p>
   */
  Refocus(long timePeriod, Item* target);
...
private:
   ...
   * <p>
   */  
  Refocus(const Refocus& refocus);

  /**
   * Private and unimplemented to enforce reference semantics
   * <p>
   */  
  Refocus& operator=(const Refocus& refocus);
