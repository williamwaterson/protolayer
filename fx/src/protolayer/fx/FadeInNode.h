#ifndef PROTOLAYER_FX_FADEINNODE_H
#define PROTOLAYER_FX_FADEINNODE_H
 ...
 */
class FadeInNode : public animation::Action
{
private:
  /** TODO: Documentation */
  bool _inProgress;
...
public:
   ...
   * <p>
   */
  FadeInNode(long timePeriod, style::Appearance& target);
...
#endif // PROTOLAYER_FX_FADEINNODE_H
