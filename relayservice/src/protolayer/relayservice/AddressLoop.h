#ifndef PROTOLAYER_RELAYSERVICE_ADDRESSLOOP_H
#define PROTOLAYER_RELAYSERVICE_ADDRESSLOOP_H
...
public:
   ...
   */
  std::string next() throw (Exception);
...
#endif // PROTOLAYER_RELAYSERVICE_ADDRESSLOOP_H
